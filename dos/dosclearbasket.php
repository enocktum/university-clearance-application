            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($incre)
						{
							$update=mysqli_query($con,"update department_dos set basket='' where incre='$incre'");
							if($update)
							{
								echo"Student's basket has been successfully cleared in dos department list<br/><a href='dosunclearedstudents.php'>Clear Student</a>";
							}
							else
							{
								echo"student's basket not successfully cleared<br/><a href='dosunclearedstudents.php'>Try Again</a>";
							}
						}
						else
						{
