...
<div class="wrapper col2">
  <div id="header" class="clear">
    ...
    <div id="topnav">
      <ul>
        <li  class="active"><a href="contact.php">Contact Us</a><span>give us your feedback</span></li>
...
<div class="wrapper col4">
  <div id="container" class="clear"> 
  	<h1>Contact Us</h1>
	<p>
	You can contact the developer of this system by:
	<br/>
	<a href="mailto:tumenock@gmail.com" title="enock tum's email" style="color:#0000CC;">tumenock@gmail.com</a> or alternatively through <a href="http://www.enocktum.netai.net/" title="enock tum's blog" style="color:#0000CC;">www.enocktum.netai.net</a>
	</p>
    <div class="clear"></div>
  </div>
</div>
