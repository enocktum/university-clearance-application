    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">library Cleared Students</h1>
						<p>
						<?php
						$year=date('Y');
						$query=mysqli_query($con,"select * from department_library where clearance_status='1'");
						$no=mysqli_num_rows($query);
						if($no==0)
						{
							echo"There are no cleared students in the library department";
						}
						else
						{
							echo"
