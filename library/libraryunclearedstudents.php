    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">library Uncleared Students</h1>
						<p>
						<?php
						$year=date('Y');
						$query=mysqli_query($con,"select * from department_library where clearance_status='2'");
						$no=mysqli_num_rows($query);
						if($no==0)
						{
							echo"There are no students who have not been cleared in the library department";
						}
						else
						{
							echo"
							...
							while($data=mysqli_fetch_array($query))
							{
								...
								else
								{
									...
									<tr>
										...
										<td>".$data['basket']."</td>
										<td>
										<form action='libraryclearstudent.php' method='post'>
							...
							<br/><br/>
							<form action='libraryclearall.php' method='post'>
