    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="foodhome.php"><i class="fa fa-fw fa-dashboard"></i> <?php echo $_SESSION['foodlogin']; ?> Home</a>
                    </li>
					
					<li>
                        <a href="foodclearedstudents.php"><i class="glyphicon glyphicon-thumbs-up"></i> Cleared Students</a>
                    </li>
					
					<li class="active">
                        <a href="foodunclearedstudents.php"><i class="glyphicon glyphicon-thumbs-down"></i> Uncleared Students</a>
                    </li>
					<li>
                        <a href="foodbasket.php"><i class="glyphicon glyphicon-bullhorn"></i> Students Basket</a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">food clear student progress</h1>
						<p>
						<?php
						$incre=$_POST['incre'];
						if($incre)
						{
							$chk=mysqli_query($con,"select * from department_food where incre='$incre' && basket=''");
							$no=mysqli_num_rows($chk);
							if($no==1)
							{
							$update=mysqli_query($con,"update department_food set clearance_status='1',basket='' where incre='$incre'");
							if($update)
							{
								echo"Student has been successfully cleared in food department list<br/><a href='foodclearedstudents.php'>Cleared Students</a>";
							}
							else
							{
								echo"student not successfully cleared<br/><a href='foodunclearedstudents.php'>Try Again</a>";
							}
							}
							else
							{
								echo"student not successfully cleared due to uncleared items<br/><a href='foodunclearedstudents.php'>Try Again</a>";
							}
						}
						else
						{
