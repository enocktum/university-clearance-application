    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">food Basket</h1>
						<p>
						<center>
						<form action="foodaddtobasket.php" method="post" style="width:100%;">
						...
						<?php
						$year=date("Y");
						$query=mysqli_query($con,"select * from department_food where basket != ''");
						...
						else
						{
							...
							while($data=mysqli_fetch_array($query))
							{
								...
								<tr>
									...
									<td>".$data['basket']."</td>
									<td>
									<form action='foodclearbasket.php' method='post'>
