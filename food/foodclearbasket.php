            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($incre)
						{
							$update=mysqli_query($con,"update department_food set basket='' where incre='$incre'");
							if($update)
							{
								echo"Student's basket has been successfully cleared in food department list<br/><a href='foodunclearedstudents.php'>Clear Student</a>";
							}
							else
							{
