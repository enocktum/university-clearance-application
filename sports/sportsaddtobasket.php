    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sports Basket addition progress</h1>
						<p>
						<?php
						...
						if($idnumber && $basket)
						{
							$query=mysqli_query($con,"select * from department_sports where idnumber='$idnumber'");
							...
							{
								$update=mysqli_query($con,"update department_sports set basket='$basket',clearance_status='2' where idnumber='$idnumber'");
								if($update)
								{
									echo"you have successfully added item(s) to student with admission number $idnumber<br/><a href='sportsbasket.php'>View Basket</a>";
								}
								else
								{
									echo"addition of items to student $idnumber not successful<br/><a href='sportsbasket.php'>Try Again</a>";
								}
							}
						}
						else
