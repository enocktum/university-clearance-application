    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sports clear student progress</h1>
						<p>
						<?php
						$incre=$_POST['incre'];
						if($incre)
						{
							$chk=mysqli_query($con,"select * from department_sports where incre='$incre' && basket=''");
							$no=mysqli_num_rows($chk);
							if($no==1)
							{
							$update=mysqli_query($con,"update department_sports set clearance_status='1',basket='' where incre='$incre'");
							if($update)
							{
								echo"Student has been successfully cleared in sports department list<br/><a href='sportsclearedstudents.php'>Cleared Students</a>";
							}
							else
							{
								echo"student not successfully cleared<br/><a href='sportsunclearedstudents.php'>Try Again</a>";
							}
							}
							else
							{
								echo"student not successfully cleared due to uncleared items<br/><a href='sportsunclearedstudents.php'>Try Again</a>";
							}
						}
						else
						{
