            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($incre)
						{
							$update=mysqli_query($con,"update department_sports set basket='' where incre='$incre'");
							if($update)
							{
								echo"Student's basket has been successfully cleared in sports department list<br/><a href='sportsunclearedstudents.php'>Clear Student</a>";
							}
							else
							{
								echo"student's basket not successfully cleared<br/><a href='sportsunclearedstudents.php'>Try Again</a>";
							}
						}
						else
						{
