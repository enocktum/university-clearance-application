    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">residence Clear all students report</h1>
						<p>
						<?php
						...
						if($show)
						{
							...
							{
								 $ch=mysqli_query($con,"select * from department_residence where idnumber='$studentid'");
								 $hc=mysqli_fetch_array($ch);
								 $basket=$hc['basket'];
								 if($basket=='')
								 {
								 	$update=mysqli_query($con,"update department_residence set clearance_status='1',basket='' where idnumber='$studentid'");
									if($update)
									{
