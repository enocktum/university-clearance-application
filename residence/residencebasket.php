    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">residence Basket</h1>
						<p>
						<center>
						<form action="residenceaddtobasket.php" method="post" style="width:100%;">
						...
						<?php
						$year=date("Y");
						$query=mysqli_query($con,"select * from department_residence where basket != ''");
