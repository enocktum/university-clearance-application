    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">residence Cleared Students</h1>
						<p>
						<?php
						$year=date('Y');
						$query=mysqli_query($con,"select * from department_residence where clearance_status='1'");
						$no=mysqli_num_rows($query);
						if($no==0)
						{
							echo"There are no cleared students in the residence department";
						}
						else
						{
							echo"
