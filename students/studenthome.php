                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									<?php
									$clearance=mysqli_query($con,"select * from department_registrar where idnumber='$username'");
                                    ...
                                    <?php
									$clearance=mysqli_query($con,"select * from department_dos where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
                                    ...
                                    <?php
									$clearance=mysqli_query($con,"select * from department_health where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
                                    ...
                                    <?php
									$clearance=mysqli_query($con,"select * from department_library where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
                                    ...
                                    <?php
									$clearance=mysqli_query($con,"select * from department_food where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
                                    ...
                                    <?php
									$clearance=mysqli_query($con,"select * from department_physicalplant where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
                                    ...
                                    <?php
									$clearance=mysqli_query($con,"select * from department_residence where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
									...
									<?php
									$clearance=mysqli_query($con,"select * from department_sports where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
									...
									<?php
									$clearance=mysqli_query($con,"select * from department_bookstore where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
						...
						<div class="panel panel-green">
                            ...
                            <div class="panel-body">
							   ...
							   you have successfully cleared from UEAB, congratulations!!
                    		   </div>
							   </div>
                            </div>
                        </div>
