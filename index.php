  ...
  <div id="header" class="clear">
    ...
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="index.php">Homepage</a><span>Clearance Home</span></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="wrapper col4">
  <div id="container" class="clear"> 
  	<h1>Welcome to Ueab Clearance System</h1>
	<p>
	Welcome user, this page allows you to automate your graduation clearance procedure by minimising your efforts and maximising the results you get from it. Login above to enjoy this services.
	</p>
    <div class="clear"></div>
  </div>
</div>
