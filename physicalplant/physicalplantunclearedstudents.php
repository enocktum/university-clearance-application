    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">physicalplant Uncleared Students</h1>
						<p>
						<?php
						$year=date('Y');
						$query=mysqli_query($con,"select * from department_physicalplant where clearance_status='2'");
						$no=mysqli_num_rows($query);
						if($no==0)
						{
							echo"There are no students who have not been cleared in the physicalplant department";
						}
						else
						{
							echo"
							...
							while($data=mysqli_fetch_array($query))
							{
								...
								$ter=mysqli_query($con,"select * from student_details where idnumber='$studentid' && year='$year'");
								...
								else
								{
									...
									<tr>
										...
										<td>".$data['basket']."</td>
										<td>
										<form action='physicalplantclearstudent.php' method='post'>
							...
							<br/><br/>
							<form action='physicalplantclearall.php' method='post'>
