    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">physicalplant Basket</h1>
						<p>
						<center>
						<form action="physicalplantaddtobasket.php" method="post" style="width:100%;">
						...
						enter the items owed:<br/>
						<textarea required style="width:100%;text-align:center;" name="basket" placeholder="enter items owed by the student(if many comma separate i.e item 1, item 2, item 3"></textarea><br/><br/>
						...
						<?php
						$year=date("Y");
						$query=mysqli_query($con,"select * from department_physicalplant where basket != ''");
						...
						else
						{
							...
							while($data=mysqli_fetch_array($query))
							{
								...
								$chek=mysqli_query($con,"select * from student_details where year='$year' && idnumber='$studentid'");
								...
								<tr>
									...
									<td>".$data['basket']."</td>
									<td>
									<form action='physicalplantclearbasket.php' method='post'>
